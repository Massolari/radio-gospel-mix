...
var author$project$Main$musicDecoder = A2(elm$json$Json$Decode$field, 'currentTrack', elm$json$Json$Decode$string);
...
var author$project$Main$getPlayingMusic = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$GotMusic, author$project$Main$musicDecoder),
